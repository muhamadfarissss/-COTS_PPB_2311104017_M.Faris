...
// class AppColors {
//   static const Color primary = Color(0xFF2F6BFF);
//   static const Color background = Color(0xFFF7F8FA); // Warna dari gambar
//   static const Color surface = Color(0xFFFFFFFF);
//   static const Color text = Color(0xFF0F172A);
//   static const Color muted = Color(0xFF64748B); // Warna dari gambar
//   static const Color border = Color(0xFFE2E8F0);
//   static const Color danger = Color(0xFFEF4444);
// }

// class AppTextStyles {
//   // Hapus 'const' karena GoogleFonts memuat font secara dinamis
